...
headingLabel = Label(headingFrame, text="Generate QR Code with GANESH", bg='mediumvioletred', font=('Times',20,'bold'))
...
label1 = Label(Frame1,text="Enter What ever you want cahnge into QRCode : ",bg="darkorchid",fg='yellow',font=('Courier',13,'bold'))
...
label2 = Label(Frame2,text="Enter the location in your (pc/lap) to save the QR Code: ",bg="darkorchid",fg='yellow',font=('Courier',13,'bold'))
...
label4 = Label(Frame4,text="Enter the size from 1 to 40 with 1 being 21x21: ",bg="darkorchid",fg='yellow',font=('Courier',13,'bold'))
...
button = Button(wn, text='Generate Code',bg="darkorchid",fg="yellow",font=('Courier',15,'normal'),command=generateCode)
